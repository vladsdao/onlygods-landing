...
'index.path.t3.subtitle': {
  ru: '963€/мес · Коллективная энергостанция',
  en: '963€/mo · Collective power station',
  ua: '963€/міс · Колективна енергостанція'
},
'index.path.t3.p1': {
...
'index.qa.q2': {
  ru: '963€ в месяц — за что именно?',
  en: '963€ per month — for what exactly?',
  ua: '963€ на місяць — за що саме?'
},
'index.qa.a2': {
